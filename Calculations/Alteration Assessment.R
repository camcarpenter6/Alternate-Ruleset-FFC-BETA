#This code is to assess the alteration from the expected the metrics at a certain comid 
#compared to the calculated metrics using the existing and altered rule set calculator

#Much of this code has been copied from ffcAPIClient/R/alteration.R developed by
# Authors Nick Santos, Ryan Peek, and Alyssa Obester
